 ...
 */
public class BrowseNewHouseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_browse_newhouse_fragment_item, container, false);
//        Toast.makeText(getActivity(),"onCreateView",Toast.LENGTH_SHORT).show();
        mListView = (ListView) view.findViewById(R.id.browse_newhouse_fragment_lv);
        mBrowseList = new ArrayList<BrowseEntity>();
        mButton_del = (Button) view.findViewById(R.id.browse_newhouse_del_btn);
...
//        Toast.makeText(this,"getFavorServerData",Toast.LENGTH_SHORT).show();
        ...
        params.put("house_type", house_type);//类型：1新房,2二手房,3租房
        params.put("userUUID", info.getUserUUID());//登录标识
