package jnhouse.topwellsoft.com.jnhouse_android.ui.chat.fragment.ease_fragment;
...
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.EaseGroupRemoveListener;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.controller.EaseUI;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.domain.ease_domain.EaseEmojicon;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.domain.ease_domain.ToChatUser;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.ease_model.EaseAtMessageHelper;
...
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.widget.ease_widget.EaseAlertDialog;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.widget.ease_widget.EaseChatExtendMenu;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.widget.ease_widget.EaseChatInputMenu;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.widget.ease_widget.EaseChatMessageList;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.widget.ease_widget.EaseVoiceRecorderView;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void initView() {
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.app_main_color_transparent, R.color.app_main_color_transparent, R.color.app_main_color_transparent, R.color.app_main_color);
    ...
    protected void setUpView() {
        String nickname = ((ToChatUser) PreferencesUtils.getObject(getActivity(), toChatUsername)).getNickname();
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            if (nickname == null || nickname.equals("")) {
                titleBar.setTitle("未设置");
            } else {
                titleBar.setTitle(nickname);
            }
            titleBar.setRightImageResource(R.drawable.ease_mm_title_remove);
            // set title
//            titleBar.setTitle(((ToChatUser) PreferencesUtils.getObject(getActivity(), ChatActivity.tochatusername)).getNickname());
//            if (EaseUserUtils.getUserInfo(toChatUsername) != null) {
//                titleBar.setTitle(((ToChatUser) PreferencesUtils.getObject(getActivity(), toChatUsername)).getNickname());
//            }
//
        }
