 ...
 */
public class QuestionSingleListAdapter extends BaseAdapter {
    private ArrayList<QuestionSingleSortEntity> list;
    private Context context;
    private LayoutInflater inflater;

    public QuestionSingleListAdapter(Context context, ArrayList<QuestionSingleSortEntity> list) {
        this.context = context;
        this.list = list;
        inflater = LayoutInflater.from(context);
    }

    public ArrayList<QuestionSingleSortEntity> getList() {
        return list;
    }
