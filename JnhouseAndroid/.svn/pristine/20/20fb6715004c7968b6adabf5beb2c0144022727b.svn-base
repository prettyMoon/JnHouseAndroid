 ...
 */
public class SellOfficeShowAllPhoto extends Activity {
    ...
    private class PreviewListener implements View.OnClickListener {
        public void onClick(View v) {
            if (LeaseShareBimp.tempSelectBitmap_leaseshare.size() > 0) {
                ...
                intent.setClass(SellOfficeShowAllPhoto.this, SellOfficeGalleryActivity.class);
    ...
    private class BackListener implements View.OnClickListener {// 返回按钮监听
        ...
        public void onClick(View v) {
            intent.setClass(SellOfficeShowAllPhoto.this, SellOfficeImageFile.class);
            startActivity(intent);
        }
    ...
    private class CancelListener implements View.OnClickListener {// 取消按钮的监听
        public void onClick(View v) {
            ...
            intent.setClass(mContext, LeaseEntire.class);
            startActivity(intent);
        }
    }
                ...
                .setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (LeaseShareBimp.tempSelectBitmap_leaseshare.size() >= PublicWay.num&&isChecked) {
                            ...
                            Toast.makeText(SellOfficeShowAllPhoto.this, Res.getString("only_choose_num"), Toast.LENGTH_SHORT)
                                    .show();
                            return;
                        }
