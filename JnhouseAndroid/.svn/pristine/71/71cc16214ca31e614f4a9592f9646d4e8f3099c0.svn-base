 ...
 */
public class SellShowAllPhoto extends Activity {
    ...
    private class PreviewListener implements View.OnClickListener {
        public void onClick(View v) {
            if (Bimp.tempSelectBitmap.size() > 0) {
                ...
                intent.setClass(SellShowAllPhoto.this, SellGalleryActivity.class);
    ...
    private class BackListener implements View.OnClickListener {// 返回按钮监听
        ...
        public void onClick(View v) {
            intent.setClass(SellShowAllPhoto.this, SellImageFile.class);
            startActivity(intent);
        }
                ...
                .setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (Bimp.tempSelectBitmap.size() >= PublicWay.num&&isChecked) {
                            ...
                            Toast.makeText(SellShowAllPhoto.this, Res.getString("only_choose_num"), Toast.LENGTH_SHORT)
                                    .show();
                            return;
                        }
