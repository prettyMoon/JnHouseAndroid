 ...
 */
public class ConsultHeadLineAdapter extends BaseAdapter {

    private ArrayList<HeadLineEntity> contentList;
    private Context context;
    private LayoutInflater inflater;
    private ImageManager manager;

    public ConsultHeadLineAdapter(Context context, ArrayList<HeadLineEntity> contentList) {
