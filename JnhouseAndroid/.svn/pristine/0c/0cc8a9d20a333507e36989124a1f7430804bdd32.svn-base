 ...
 */
public class BrowseRentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_browse_rent_fragment_item,container,false);
//        Toast.makeText(getActivity(),"onCreateView",Toast.LENGTH_SHORT).show();
        mListView = (ListView) view.findViewById(R.id.browse_rent_fragment_lv);
        mBrowseList = new ArrayList<BrowseEntity>();
        mButton_del = (Button) view.findViewById(R.id.browse_rent_del_btn);
        ...
        initDialog();
        try {
            getFavorServerData(JnHouse_Record.Key_my_history);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return view;
...
//        Toast.makeText(this,"getFavorServerData",Toast.LENGTH_SHORT).show();
        ...
        Log.i("#####","user_id:"+info.getUser_id());
        params.put("house_type", house_type);//
        params.put("cur_index", cur_index);//当前页
        params.put("userUUID", info.getUserUUID());//登录标识
        Log.i("#####","userUUID:"+info.getUserUUID());
        FinalHttp fh = new FinalHttp();
        fh.get(url, params, new AjaxCallBack<Object>() {

            @Override
            public void onFailure(Throwable t, int errorNo, String strMsg) {
                Toast.makeText(getActivity(),"错误代码:"+errorNo+"\t"+strMsg,Toast.LENGTH_LONG).show();
            }
