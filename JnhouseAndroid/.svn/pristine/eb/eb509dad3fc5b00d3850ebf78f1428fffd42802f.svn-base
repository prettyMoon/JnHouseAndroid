 ...
 */
public class MineSellOfficeListViewAdapter extends BaseAdapter {
    private List<MineSellOfficeEntity> contentList;
    ...
    public MineSellOfficeListViewAdapter(Context context, List<MineSellOfficeEntity> contentList) {
    ...
    public MineSellOfficeListViewAdapter() {
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.list_view_mine_selloffice_item, null);
            Log.i("#####","getView_if  "+position);
        }

        holder.layout = (LinearLayout) convertView.findViewById(R.id.layout_del);
        holder.mCheckBox = (CheckBox) convertView.findViewById(R.id.sellofficelist_checkbox);
        ...
        holder.tvHouse_title = (TextView) convertView.findViewById(R.id.mine_sell_office_title_tv);
        holder.tvBuiding_type = (TextView) convertView.findViewById(R.id.mine_sell_office_style_tv);
        holder.tvHouse_price = (TextView) convertView.findViewById(R.id.mine_sell_office_price_tv);
        holder.tvHouse_area = (TextView) convertView.findViewById(R.id.mine_sell_office_area_tv);
        ...
        holder.tvBuiding_type.setText(contentList.get(position).getBuiding_type());
    ...
    public class ListViewHolder {
        public TextView tvId, tvHouse_title, tvBuiding_type,tvHouse_price,tvHouse_area,tvState,tvBorough_name;
