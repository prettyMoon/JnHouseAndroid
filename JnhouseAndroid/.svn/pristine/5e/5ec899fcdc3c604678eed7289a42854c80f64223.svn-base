 ...
 */
package jnhouse.topwellsoft.com.jnhouse_android.ui.chat.activity.ease_activity;
...
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.ease_model.EaseImageCache;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.utils.ease_utils.EaseLoadLocalBigImgTask;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.widget.ease_widget.photoview.EasePhotoView;
...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (uri != null && new File(uri.getPath()).exists()) {
            ...
            //new ImageManager(EaseShowBigImageActivity.this).loadUrlImage();
        } else {
