...
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.fragment.ease_fragment.EaseConversationListFragment;
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.widget.ease_widget.EaseConversationList;
...
public class ConversationListFragment extends EaseConversationListFragment {
        ...
        conversationListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (username.equals(EMClient.getInstance().getCurrentUser()))
                    ...
                    EmChatHelper.startChatActivity(getActivity(), username, "list");
                }
            }
        });
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        // update unread count
        ((MainTabsActivity) getActivity()).updateUnreadLabel();
        return true;
    }
