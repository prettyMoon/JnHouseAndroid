package jnhouse.topwellsoft.com.jnhouse_android.ui.chat.db;
...
import jnhouse.topwellsoft.com.jnhouse_android.ui.chat.domain.chat_domain.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(JnHouseApplication.getInstance().getApplicationContext());
    }
