 ...
 */
public class SellOfficeAlbumActivity extends Activity {
    //显示手机里的所有图片的列表控件
    ...
    private class PreviewListener implements View.OnClickListener {
        public void onClick(View v) {
            if (LeaseShareBimp.tempSelectBitmap_leaseshare.size() > 0) {
                ...
                intent.setClass(SellOfficeAlbumActivity.this, SellOfficeGalleryActivity.class);
    ...
    private class BackListener implements View.OnClickListener {
        public void onClick(View v) {
            intent.setClass(SellOfficeAlbumActivity.this, SellOfficeImageFile.class);
            startActivity(intent);
        }
    }
                    ...
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (LeaseShareBimp.tempSelectBitmap_leaseshare.size() >= PublicWay.num) {
                            ...
                            if (!removeOneData(dataList.get(position))) {
                                Toast.makeText(SellOfficeAlbumActivity.this, Res.getString("only_choose_num"),
