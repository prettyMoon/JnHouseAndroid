 ...
 */
public class FilterTypeAdapter extends BaseListAdapter<FilterEntity>  {
    ...
    public FilterTypeAdapter(Context context, List<FilterEntity> list) {
        super(context, list);
        this.mList = list;
    }

//    public void setSelectedEntity(List<FilterEntity> filterEntity) {
//        mList = filterEntity;
//    }
