package jnhouse.topwellsoft.com.jnhouse_android.view.SmoothListView;
 ...
 */
public class IndexSmoothListView extends ListView implements AbsListView.OnScrollListener {


    private float mLastY = -1; // save event y
    private Scroller mScroller; // used for scroll icon_titlebar_back
    ...
    // for mScroller, scroll icon_titlebar_back from header or footer.
    private int mScrollBack;
    private final static int SCROLLBACK_HEADER = 0;
    private final static int SCROLLBACK_FOOTER = 1;

    private final static int SCROLL_DURATION = 400; // scroll icon_titlebar_back duration
    private final static int PULL_LOAD_MORE_DELTA = 0; // when pull up >= 50px
    // at bottom, trigger
    // load more.
    private final static float OFFSET_RADIO = 1.8f; // support iOS like pull
    // feature.
    public IndexSmoothListView(Context context) {
        super(context);
        initWithContext(context);
    }

    public IndexSmoothListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWithContext(context);
    }

    public IndexSmoothListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void resetHeaderHeight() {
        ...
        int finalHeight = 0; // default: scroll icon_titlebar_back to dismiss header.
        // is refreshing, just scroll icon_titlebar_back to show all the header.
        if (mPullRefreshing && height > mHeaderViewHeight) {
...
//                    updateHeaderHeight(deltaY / OFFSET_RADIO);
     ...
     * onSmoothScrolling when header/footer scroll icon_titlebar_back.
     */
