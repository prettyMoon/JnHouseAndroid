...
/**
 * Created by chenchen on 2016/9/2.
 */
public class PopListWindow extends PopupWindow{

    private View mView;
    public PopListWindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater=(LayoutInflater)context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
        mView=inflater.inflate(R.layout.activity_listpopwindow,null);
