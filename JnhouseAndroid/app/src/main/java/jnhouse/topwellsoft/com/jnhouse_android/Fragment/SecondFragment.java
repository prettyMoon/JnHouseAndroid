...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_second_fragment_item, container, false);
        mListView = (ListView) view.findViewById(R.id.collection_second_fragment_listView);
        mCollectionList = new ArrayList<CollectionEntity>();
        mButton_del = (Button) view.findViewById(R.id.collection_del_btn);
