 ...
 */
public class SellAlbumActivity extends Activity {
    //显示手机里的所有图片的列表控件
    ...
    private class PreviewListener implements View.OnClickListener {
        public void onClick(View v) {
            if (Bimp.tempSelectBitmap.size() > 0) {
                ...
                intent.setClass(SellAlbumActivity.this, SellGalleryActivity.class);
    ...
    private class BackListener implements View.OnClickListener {
        public void onClick(View v) {
            intent.setClass(SellAlbumActivity.this, SellImageFile.class);
            startActivity(intent);
        }
    }
                    ...
                    public void onItemClick(final ToggleButton toggleButton,
                        ...
                        if (Bimp.tempSelectBitmap.size() >= PublicWay.num) {
                            ...
                            if (!removeOneData(dataList.get(position))) {
                                Toast.makeText(SellAlbumActivity.this, Res.getString("only_choose_num"),
