...
public class Information extends AppCompatActivity {
    private RelativeLayout mRelativeLayout_headportrait,mRelativeLayout_nickname,mRelativeLayout_change_password,seting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRelativeLayout_change_password = (RelativeLayout) findViewById(R.id.information_change_password_layout);
         seting=(RelativeLayout)findViewById(R.id.information_change_seting_layout);
        ...
        seting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(Information.this, SettingActivity.class);
