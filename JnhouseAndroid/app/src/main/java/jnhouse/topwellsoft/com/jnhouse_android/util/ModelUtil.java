...
public class ModelUtil {
    ...
    public static List<OperationEntity> getOperationData() {
        ...
        operationList.add(new OperationEntity("置业顾问", "", "http://img2.imgtn.bdimg.com/it/u=4081165325,36916497&fm=21&gp=0.jpg"));
   ...
   //出租类型
    public  static List<FilterEntity>getRentType(){
        List<FilterEntity> list = new ArrayList<>();
        list.add(new FilterEntity("整租","1"));
        list.add(new FilterEntity("合租","2"));
        return list;
    }
    //类型
    ...
    public static List<FilterEntity> getListRentSortData() {
        List<FilterEntity> list = new ArrayList<>();
        list.add(new FilterEntity("默认", "1"));
        list.add(new FilterEntity("发布时间", "2"));
        list.add(new FilterEntity("租金由低到高", "3"));
        list.add(new FilterEntity("租金由高到低", "4"));
        list.add(new FilterEntity("面积由小到大", "5"));
        list.add(new FilterEntity("面积由大到小", "6"));
        return list;
    }
  ...
  public  static  List<FilterEntity>getListNewData(){
    ...
    public static List<FilterEntity>getHouseFitment(){
        List<FilterEntity> list = new ArrayList<>();
        list.add(new FilterEntity("毛坯","1"));
        list.add(new FilterEntity("普通装修","2"));
        list.add(new FilterEntity("精装修","3"));
        list.add(new FilterEntity("豪华装修","4"));
