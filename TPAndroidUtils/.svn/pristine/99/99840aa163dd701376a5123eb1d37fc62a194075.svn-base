...
public class TPLocationListener implements BDLocationListener {

    public LocationClient mLocationClient = null;
    public BDLocation location = null;

    public TPLocationListener() {
        super();
        mLocationClient = new LocationClient(GlobalObjects.theApplication);
        callbackList = new ArrayList<LocationCallback>();
    ...
    public List<LocationCallback> getCallbackList() {
        return callbackList;
    ...
    synchronized public void checkLocation(LocationCallback callback) {
    ...
    private void initLocation() {
        ...
        option.setScanSpan(1000 * 60*2);//可选，默认0，即仅定位一次，设置发起定位请求的间隔需要大于等于1000ms才是有效的
    ...
    public void onReceiveLocation(BDLocation location) {
        ...
        try {
            ...
            for (LocationCallback b : callbackList) {
